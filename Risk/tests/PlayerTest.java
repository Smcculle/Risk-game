...
public class PlayerTest extends TestCase {
    ...
    public void hasTerritory()
    {
    	...
    	assertEquals( test1.hasTerritory(), false );
    	
    	test1.addTerritory( t1 );
    	assertEquals( test1.hasTerritory(), true );
    	
    	test1.removeTerritory( t1 );
    	assertEquals( test1.hasTerritory(), false );
    }
    ...
    {
    	Territory t1 = new Territory( "t1", null );
    	assertEquals( test1.getNumTerritories(), 0 );
    	
    	test1.addTerritory( t1 );
    	assertEquals( test1.getNumTerritories(), 1 );
    ...
    {
    	assertEquals( test1.getUnplacedArmies(), 0 );
    	assertEquals( test2.getUnplacedArmies(), 0 );
    	
    	test1.addArmies(5);
    	assertEquals( test1.getUnplacedArmies(), 5 );
    	
    	/* armies haven't been placed yet, so they should be cumulative */
    	test1.addArmies(10);
    	assertEquals( test1.getUnplacedArmies(), 15 );
    ...
    public void testGetTotalArmies() 
    {
    	...
    	assertEquals( test1.getTotalArmies(), 0 );
    	
    	test1.addTerritory( t1 );
    	assertEquals( t1.getOccupant(), test1 );
    	assertEquals( test1.getTotalArmies(), 1 );
    	
    	test1.addTerritory( t2 );
    	assertEquals( t1.getOccupant(), test1 );
    	assertEquals( t2.getOccupant(), test1 );
    	assertEquals( test1.getTotalArmies(), 3 );
    	
    	test1.addTerritory( t3 );
    	assertEquals( test1.getTotalArmies(), 6 );
    	
    	test1.removeTerritory( t1 );  // should remove 1 army
    	assertEquals( test1.getTotalArmies(), 5 );
    ...
    {
    	assertEquals( test1.getTerritoriesList().size(), 0 );
		...
		HashMap<String, Territory> gtl = 
				(HashMap<String, Territory>)test1.getTerritoriesList();
    ...
    public void testGetContinentsList() 
    {
    	...
    	assertEquals( test1.getContinentsList().size(), 0 );
    	test1.addContinent( con1 );
    	test1.addContinent( con2 );
    	
    	HashMap<String, Continent> gcl = 
    			(HashMap<String, Continent>)test1.getContinentsList();
    ...
    public void testAddArmies() 
    {
    	...
    	test2.addArmies(1);
    	assertEquals( test2.getUnplacedArmies(), 1 );
    	
    	test2.addArmies(0);
    	assertEquals( test2.getUnplacedArmies(), 1 );
    	
    	test2.addArmies(5);
    	assertEquals( test2.getUnplacedArmies(), 6 );
    ...
    */
    public void testAttack() 
    {
        ...
        assertEquals( test1.getHandSize(), 0 );
        assertEquals( test2.getHandSize(), 0 );
        test2.addCard( new Card( "Type", "Territory" ) );
        test2.addCard( new Card( "Type2", "Territory2" ) );
        assertEquals( test2.getHandSize(), 2 );
        
        /* after attacking, either t1 or t2 has less armies than before, or both */
        test1.attack( t1, t2, dice.roll( 3, 2 ) );
        ...
        while( t2.getOccupant() == test2 && t1.getNumArmies() > 0  )
        {
        ...
        assertEquals( test1.getHandSize(), 2 );
        ...
        assertEquals( t3.getOccupant(), test1 );
        assertEquals( t3.getNumArmies(), 2 );
        assertEquals( test1.getHandSize(), 3 );
        ...
        assertEquals( t4.getOccupant(), test1 );
        assertEquals( t4.getNumArmies(), 1 );
        assertEquals( test1.getHandSize(), 4 );
        
        int [] set = {0, 1, 2, 3};
        java.util.ArrayList<Card> cardList = test1.turnInSet( set );
